 ...
 */
public class DBAuthenticatorMySQL implements IAuthenticator {

    private static final Logger LOG = LoggerFactory.getLogger(DBAuthenticatorMySQL.class);

    private final MessageDigest messageDigest;
    private final PreparedStatement preparedStatement;

    public DBAuthenticatorMySQL(IConfig conf) {
        this(
     ...
     */
    public DBAuthenticatorMySQL(String driver, String jdbcUrl, String sqlQuery, String digestMethod) {
