 ...
 */
public class Server extends AbstractInterceptHandler {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            IConfig conf = new ResourceLoaderConfig(classpathLoader);
            final Server server = new Server();
            List<? extends InterceptHandler> userHandlers = Collections.singletonList(server);
            server.startServer(conf, userHandlers);
    ...
    public void startServer() throws IOException {
        ...
        config = new ResourceLoaderConfig(filesystemLoader);
        startServer(config);
    }
    ...
    /**
     * Starts Moquette with config provided by an implementation of IConfig
     * class and with the set of InterceptHandler.
     *
     * @param config the configuration to use to start the broker.
    ...
    /**
     * Use the broker to publish a message. It's intended for embedding
     * applications. It can be used only after the server is correctly started
     * with startServer.
     *
    ...
    /**
     * SPI method used by Broker embedded applications to get list of
     * subscribers. Returns null if the broker is not started.
     *
    ...
    /**
     * SPI method used by Broker embedded applications to remove intercept
     * handlers.
     *
