...
import io.moquette.spi.impl.security.DBAuthenticatorMySQL;
...
public class ServerIntegrationDBAuthenticatorTest {
    ...
    private Properties addDBAuthenticatorConf(Properties properties) {
        properties.put(BrokerConstants.AUTHENTICATOR_CLASS_NAME, DBAuthenticatorMySQL.class.getCanonicalName());
